class SalesController < ApplicationController
  ...
  def add_item
    ...
    importe_producto = producto.price * cantidad
    ...
    result = {
      ...
      precio_producto: producto.price.to_f,
      nombre_prod:     @sale_detail.product.try(:name),
      cantidad:        @sale_detail.cantidad,
      importe_item:    producto.price * cantidad,
  ...
  def add_cliente 
    ...
    if cliente.present?
      ...
      if @venta.valid?
        result = { nombre_cliente: @venta.client.try(:name) }
